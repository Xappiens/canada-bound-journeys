...
const etapas = [
  ...
  },
  {
    ...
    atracciones: ["Gastown", "Chinatown", "Yaletown", "Puerto de Vancouver"],
  },
];
      ...
      <header className="w-full flex flex-col md:flex-row items-center justify-between px-6 py-4 bg-gradient-to-r from-blue-900 via-blue-700 to-blue-500 text-white shadow-lg">
        <div>
          <h1 className="text-2xl md:text-3xl font-bold mb-1">
            Aventura Canadá Salvaje: Grupo septiembre 2025
          </h1>
          <p className="text-sm md:text-base">
            10 días / 8 noches — Grupo de 8 personas
          </p>
        </div>
        <div className="mt-4 md:mt-0 flex flex-col md:flex-row md:items-center gap-2">
          <span className="bg-red-100 text-red-700 px-4 py-1 rounded-full font-semibold mb-2 md:mb-0 md:mr-4">
            ¡4 viajeros confirmados! Quedan 4 plazas
          </span>
          <Link
            to="/reserva-grupo-septiembre-2025"
            className="bg-red-600 hover:bg-red-700 text-white font-bold px-6 py-2 rounded shadow transition text-center"
          >
            Reservar plaza
          </Link>
        </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="text-gray-800">
              ...
              <p className="text-sm text-gray-600">
                Incluye: Vuelos internacionales, traslados, alojamiento,
                desayunos, actividades guiadas y seguro de viaje
              </p>
            </div>
            <div className="mt-4 md:mt-0">
              <Link
                to="/reserva-grupo-septiembre-2025"
                className="inline-block bg-green-600 hover:bg-green-700 text-white font-bold px-6 py-2 rounded shadow transition"
              >
                Solicitar información detallada
              </Link>
              <div className="mt-2 text-center text-gray-600 text-sm flex items-center justify-center gap-2">
                <span>Desliza para ver las etapas</span>
                <svg
